# Django settings for block_twitter_test project.
import os
...
AUTHENTICATION_BACKENDS = (
    ...
    #'twitter_app.auth.GoogleBackend',
    )
...
SECRET_KEY = 'p&amp;*_2c%+wgv7a1kth1l#o5th)dhf%-3z3%)59&amp;t#9$95oe8w!d'
...
ROOT_URLCONF = 'block_twitter_test.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'block_twitter_test.wsgi.application'
...
#http://twitterblock.herokuapp.com/twitter/return
